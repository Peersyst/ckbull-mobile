...
export const ChipRoot = styled(View)<ChipRootProps>(({ theme, variant, fullWidth }) => ({
    ...
    ...(variant === "primary" && {
        borderColor: theme.palette.mode === "dark" ? "transparent" : theme.palette.overlay[700]["8%"],
        backgroundColor: theme.palette.mode === "dark" ? theme.palette.gray[900] : theme.palette.overlay[700]["8%"],
    }),
}));
...
export const ChipText = styled(Text)<ChipTextProps>(({ theme, variant }) => ({
    ...
    ...(variant === "secondary" && {
        color: theme.palette.mode === "dark" ? theme.palette.gray[900] : theme.palette.overlay[700]["8%"],
    }),
    ...(variant === "primary" && {
        color: theme.palette.mode === "dark" ? theme.palette.gray[0] : theme.palette.overlay[700]["8%"],
    }),
}));
